...
<head>
  ...
  <meta charset="UTF-8">
  <meta name="description" content="エンジニアを目指すKyoのポートフォリオサイトです。私がこれまでに手がけた制作物、身につけたスキルをまとめています。">
    ...
    <div class="top-wrapper animate">
      <div class="container">
        <div class="top-message">
          ...
          <p>こちらはエンジニアを目指す私Kyoのポートフォリオサイトです。<br>
