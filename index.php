        ...
        <div class="contact">
          ...
          <form action="" method="POST" novalidate>
            <label for="name"><span class="must">必須</span>お名前</label>
              ...
              <?php endif; ?>
            <input type="text" id="name" name="name" class="contact-text" value="<?php echo htmlspecialchars($post['name']); ?>" required>
            <label for="email"><span class="must">必須</span>メールアドレス</label>
              ...
              <?php endif; ?>
            <input type="email" id="email" name="email" class="contact-email" value="<?php echo htmlspecialchars($post['email']); ?>" required>
            <label for="message"><span class="must">必須</span>メッセージ</label>
              <?php if ($error['message'] === 'blank'): ?>
                <p class="error-msg">※メッセージをご記入下さい</p>
              <?php endif; ?>
            <textarea id="message" name="message" required><?php echo htmlspecialchars($post['message']); ?></textarea>
